...
<li> Attack and defense stats are vizualized differently, which makes them seem like they are visualizing the same thing, even though they represent completely different values. </li>
<li> Using only one color makes the intervals of the attack stats unreadable. Without an explanation, it’s impossible to understand what precentagesmthese intervals represent. </li>
